...
export default function OurWorkSection() {
  ...
  const work = {
    ...
    videoSrc: "/videos/our-work.mp4", // Apni video file ka path yahan rakhein
    link: "/work",
  };

  return (
    <section className="relative w-full h-screen bg-[#08050c] text-white flex flex-col items-center justify-center gap-6 md:gap-8 px-4 py-6 overflow-hidden">
      ...
      <div className="relative z-10 w-[85vw] max-w-[1250px] aspect-[16/9] max-h-[58vh] flex items-center justify-center shrink-0 group my-1">
