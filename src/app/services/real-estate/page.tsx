...
export default function RealEstateServicePage() {
  ...
  // Auto-scroll to center on mount so both left & right videos peek through
  useEffect(() => {
    if (ourWorkScrollRef.current) {
      const el = ourWorkScrollRef.current;
      el.scrollLeft = (el.scrollWidth - el.clientWidth) / 2;
    }
    if (beforeAfterScrollRef.current) {
      const el = beforeAfterScrollRef.current;
      el.scrollLeft = (el.scrollWidth - el.clientWidth) / 2;
    }
  }, []);
  ...
  return (
    <div ref={pageRef} className="w-full bg-[#06030a] text-white min-h-screen selection:bg-purple-600 selection:text-white overflow-hidden">
      ...
      <section className="relative z-10 w-full flex flex-col items-center justify-center pt-32 pb-16 md:pt-44 md:pb-24 px-4 sm:px-6 max-w-7xl mx-auto">
        <div className={`z-10 text-center max-w-5xl mx-auto px-4 ${cinzel.className}`}>
          {/* Badge Section */}
          ...
          {/* MAIN HEADLINE */}
          <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-[100px] font-black tracking-wider uppercase bg-gradient-to-b from-white via-purple-100 to-purple-300 bg-clip-text text-transparent drop-shadow-2xl leading-[1.08] my-4">
            REAL ESTATE
          </h1>
          ...
          <div
            ref={btnRef}
            className="mt-10 sm:mt-12 lg:mt-14 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 lg:gap-8 w-full sm:w-auto px-4 sm:px-0 font-sans"
          >
            {/* Book a Call Button */}
            <Link
              href="/#book-call"
      ...
      {/* ================= OUR WORK (CENTERED CAROUSEL) ================= */}
      <section id="our-work" className="relative w-full bg-[#06030a] text-white flex flex-col items-center justify-center py-16 sm:py-20 md:py-28 overflow-hidden select-none border-t border-purple-950/40">
        <div className={`z-10 text-center max-w-4xl mx-auto mb-12 sm:mb-16 px-4 ${cinzel.className}`}>
        ...
        {/* Scroll Container (Starts at Center) */}
        <div className="relative z-10 w-full">
          <div
            ref={ourWorkScrollRef}
            className="flex overflow-x-auto gap-6 sm:gap-8 px-8 sm:px-16 pb-4 snap-x snap-mandatory items-center justify-start scrollbar-none [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
          >
            {ourWorkList.map((item) => (
              <div key={item.id} className="snap-center shrink-0">
                <div className="relative aspect-[9/16] w-[210px] sm:w-[250px] md:w-[270px] rounded-[24px] overflow-hidden border border-purple-500/40 shadow-[0_10px_30px_rgba(0,0,0,0.8)] group bg-[#0d071a]">
                  <video
                    src={item.video}
                    loop
                    muted
      ...
      {/* ================= BEFORE / AFTER DECK ================= */}
      <section className="relative z-10 w-full py-16 sm:py-20 md:py-28 border-t border-purple-950/40 bg-[#06030a]">
        <div className={`z-10 text-center max-w-4xl mx-auto mb-12 sm:mb-16 px-4 ${cinzel.className}`}>
          <p className="text-[10px] sm:text-xs md:text-sm uppercase tracking-[0.3em] sm:tracking-[0.4em] text-purple-300/70 mb-2">
          ...
          <div className="w-full relative p-6 sm:p-8 rounded-3xl border border-purple-500/30 bg-[#0a0514]/80 backdrop-blur-xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] overflow-hidden">
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-2xl bg-purple-950/80 border border-purple-400/40 flex items-center justify-center shrink-0 text-purple-300 shadow-[0_0_15px_rgba(168,85,247,0.3)]">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-white font-bold text-sm mb-1">No Time Limit</h4>
                  <p className="text-gray-300 text-xs leading-relaxed font-light">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-white font-bold text-sm mb-1">Free Revisions</h4>
                  <p className="text-gray-300 text-xs leading-relaxed font-light">
